...
contract BRAIN is ERC721, ERC721Enumerable, Ownable {
    ...
    uint256 public constant tokenPresalePrice = 40000000000000000; // 0.04 ETH
    uint256 public constant tokenPublicsalePrice = 50000000000000000; // 0.05 ETH
    ...
    function preSaleToken(uint[] tokenIds) public payable {
    ...
    function mintToken(uint[] tokenIds) public payable {
    ...
    function changePublicsalePrice ( uint price ) public onlyOwner {
        tokenPublicsalePrice = price
        emit TokenPriceChagned( _price)
    }
